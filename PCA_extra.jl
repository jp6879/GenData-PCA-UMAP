...
# ╔═╡ 73b8dd42-187a-4150-a35e-9060f1211b7c
begin
	using DataFrames
	using CSV
	using LaTeXStrings
...
# ╔═╡ 4e134860-6adc-11ee-0e0b-6363ba70ed00
md"# Extra PCA"

# ╔═╡ 1d9b5d01-4155-4001-a818-dce06e237e35
begin
...
# ╔═╡ 2d31b7ab-524a-4cdb-8838-93a3ed99e615
function GetData(path_read)
	my_file_data = CSV.File(HTTP.get(path_read).body)
	df_data = DataFrame(my_file_data)
    data = Matrix(df_data)
    return data
end;

# ╔═╡ 3dca1746-1ec7-451e-9213-fbb145780425
begin
	path_in = "https://media.githubusercontent.com/media/jp6879/GenData-PCA-UMAP/main/Little_Data/Little_Data_CSV/dataSignals.csv"
	path_out = "https://media.githubusercontent.com/media/jp6879/GenData-PCA-UMAP/main/Little_Data/Little_Data_CSV/dataProbd.csv"
	
	dataIN = GetData(path_in)
	dataOUT = GetData(path_out)
end;

# ╔═╡ c4d8234f-aeb8-434d-a0d5-648ff697eb9d
begin
	data_url = "https://media.githubusercontent.com/media/jp6879/GenData-PCA-UMAP/main/Little_Data/Little_Data_CSV/df_PCA_Signals.csv"
	my_file = CSV.File(HTTP.get(data_url).body)
	df_PCASignals = DataFrame(my_file)
	data_url_2 = "https://media.githubusercontent.com/media/jp6879/GenData-PCA-UMAP/main/Little_Data/Little_Data_CSV/df_PCA_Probd.csv"
	my_file_2 = CSV.File(HTTP.get(data_url_2).body)
	df_PCAProbd = DataFrame(my_file_2)
end;

# ╔═╡ 596aab5f-c1e5-47e9-9842-ecb28bef14a6
	@bind find_σ Slider(σs, 0.01, true)

# ╔═╡ 847d2252-b114-4e78-a2a1-6b258d9ce09a
begin
	md"σ = $(find_σ) "
end

# ╔═╡ 048b60f2-8d7f-44ca-bc2b-0d3d5043cd67
@bind find_lcm Slider(lcms, 0.5, true)

# ╔═╡ 72322c60-e03d-4894-82ec-597dd672ec4e
begin
	md" $l_{cm}$ = $(find_lcm)"
end

# ╔═╡ bcdedb05-6a46-43c4-9e6d-8fce726f93e7
begin
...
# ╔═╡ f4e70219-15c7-4660-8623-a403484d2f45
begin
	x = df_PCASignals.pc1[find_index]
	y = df_PCASignals.pc2[find_index]
...
# ╔═╡ bf5eaaed-d7e8-4f9f-a615-dda66648af94
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "320160a30e9a76dbbc7e959eeec5c16e46977a82"
