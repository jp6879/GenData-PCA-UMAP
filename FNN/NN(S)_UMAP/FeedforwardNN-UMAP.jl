...
savefig(plot_lcms_P, "C:\\Users\\Propietario\\Desktop\\ib\\5-Maestría\\GenData-PCA-UMAP\\FNN\\NN(S)_UMAP\\Plots\\UMAP_0.05_100.png")
...
println("R2 score: $(R2_score(model(datasignals), dataprobd)) || RMSE: $(RMSE(model(datasignals), dataprobd)) || MAE: $(MAE(model(datasignals), dataprobd))")
println("R2 score valid: $(R2_score(model(datasignals_valid), dataprobd_valid)) || RMSE valid: $(RMSE(model(datasignals_valid), dataprobd_valid)) || MAE valid: $(MAE(model(datasignals_valid), dataprobd_valid))")
...
yaxis!(pl_loss, (0.01, 1), log = true)
xlims!(5, epochs)

savefig(pl_loss, "C:\\Users\\Propietario\\Desktop\\ib\\5-Maestría\\GenData-PCA-UMAP\\FNN\\NN(S)_UMAP\\Plots\\Loss.png")
...
savefig(plot_lcms_P_pred, "C:\\Users\\Propietario\\Desktop\\ib\\5-Maestría\\GenData-PCA-UMAP\\FNN\\NN(S)_UMAP\\Plots\\Predict.png")
