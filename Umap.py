...
save_path = "C:\\Users\\Propietario\\Desktop\\ib\\5-Maestría\\GenData-PCA-UMAP\\Datos\\Datos_UMAP"
...
# normalize dataprobd minmax
# data_probd = (data_probd - data_probd.min()) / (data_probd.max() - data_probd.min())
...
df_UMAPprobd.to_csv(os.path.join(save_path, f"df_UMAP_Probd_mdist_{min_dist}_nn_{n_neighbors}_nc_{n_components}.csv"), index=False)
